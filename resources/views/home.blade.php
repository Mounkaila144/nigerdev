    ...
    <section class="hero-5 bg-light" id="home">
        <div class="container">
            <div class="row justify-content-center text-center hero-content">
                <div class="col-lg-8">
                    <h1 class="hero-title fw-bold mb-4 display-4 text-nowrap" style="font-family:Chalkboard">
                    ...
                    <div class="screen-slider overflow-hidden">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="images/screen-shot/1.jpg" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
                                <img src="images/screen-shot/6.jpg" alt="" class="img-fluid" />
                            </div>
                            <div class="swiper-slide">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="testimonial-box text-center">
                        ...
                        <img src="images/users/user-1.jpg" alt="" class="shadow rounded-circle" width="70" />
            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mb-1"><i class="mdi mdi-arrow-right-thin text-muted me-1"></i><a href="javascript:void(0);" class="text-secondary">JuanaMRush@jourrapide.com</a></p>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mb-1"><i class="mdi mdi-arrow-right-thin text-muted me-1"></i><a href="javascript:void(0);" class="text-secondary">(+01) 1234 5678 00</a></p>
